...
pattern = r"(<!-- ============================\s*ROADMAP / TIMELINE\s*============================ -->.*?)(?:\n\s*</section>\s*\n)"
match = re.search(pattern, content, re.DOTALL)
if not match:
    print("Not found")
    exit()

roadmap_old = match.group(1) + "\n    </section>\n"
            ...
            <div style="display:flex;flex-direction:column;width:100%;">
                ...
                <div class="reveal" style="display:flex;align-items:stretch;width:100%;">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;position:relative;width:24px;flex-shrink:0;">
                        ...
                        <div style="width:16px;height:16px;border-radius:50%;background:#1e3a6e;border:4px solid white;box-shadow:0 0 0 4px #1e3a6e;position:relative;z-index:2;margin-top:10px;"></div>
                    </div>
                ...
                <div class="reveal reveal-delay-1" style="display:flex;align-items:stretch;width:100%;">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;position:relative;width:24px;flex-shrink:0;">
                        ...
                        <div style="width:16px;height:16px;border-radius:50%;background:#1a56db;border:4px solid white;box-shadow:0 0 0 4px #1a56db;position:relative;z-index:2;margin-top:10px;"></div>
                    </div>
                    <div style="flex:1;padding-left:2.5rem;padding-bottom:3.5rem;">
                        <div style="background:white;border-radius:1.25rem;padding:2rem 2.25rem;box-shadow:0 4px 20px rgba(30,58,110,0.06);border:1px solid rgba(30,58,110,0.05);transition:transform 0.3s, box-shadow 0.3s;" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 12px 30px rgba(30,58,110,0.12)';" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 4px 20px rgba(30,58,110,0.06)';">
                ...
                <div class="reveal reveal-delay-2" style="display:flex;align-items:stretch;width:100%;">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;position:relative;width:24px;flex-shrink:0;">
                        ...
                        <div style="width:16px;height:16px;border-radius:50%;background:#2563eb;border:4px solid white;box-shadow:0 0 0 4px #2563eb;position:relative;z-index:2;margin-top:10px;"></div>
                    </div>
                    <div style="flex:1;padding-left:2.5rem;padding-bottom:3.5rem;">
                        <div style="background:white;border-radius:1.25rem;padding:2rem 2.25rem;box-shadow:0 4px 20px rgba(30,58,110,0.06);border:1px solid rgba(30,58,110,0.05);transition:transform 0.3s, box-shadow 0.3s;" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 12px 30px rgba(30,58,110,0.12)';" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 4px 20px rgba(30,58,110,0.06)';">
                ...
                <div class="reveal reveal-delay-3" style="display:flex;align-items:stretch;width:100%;">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;position:relative;width:24px;flex-shrink:0;">
                        ...
                        <div style="width:16px;height:16px;border-radius:50%;background:#3b82f6;border:4px solid white;box-shadow:0 0 0 4px #3b82f6;position:relative;z-index:2;margin-top:10px;"></div>
                    </div>
                    <div style="flex:1;padding-left:2.5rem;padding-bottom:3.5rem;">
                        <div style="background:white;border-radius:1.25rem;padding:2rem 2.25rem;box-shadow:0 4px 20px rgba(30,58,110,0.06);border:1px solid rgba(30,58,110,0.05);transition:transform 0.3s, box-shadow 0.3s;" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 12px 30px rgba(30,58,110,0.12)';" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 4px 20px rgba(30,58,110,0.06)';">
                ...
                <div class="reveal reveal-delay-4" style="display:flex;align-items:stretch;width:100%;">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;position:relative;width:24px;flex-shrink:0;">
                        ...
                        <div style="width:16px;height:16px;border-radius:50%;background:#60a5fa;border:4px solid white;box-shadow:0 0 0 4px #60a5fa;position:relative;z-index:2;margin-top:10px;"></div>
                    </div>
                    <div style="flex:1;padding-left:2.5rem;padding-bottom:3.5rem;">
                        <div style="background:white;border-radius:1.25rem;padding:2rem 2.25rem;box-shadow:0 4px 20px rgba(30,58,110,0.06);border:1px solid rgba(30,58,110,0.05);transition:transform 0.3s, box-shadow 0.3s;" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 12px 30px rgba(30,58,110,0.12)';" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 4px 20px rgba(30,58,110,0.06)';">
                ...
                <div class="reveal" style="display:flex;align-items:stretch;width:100%;">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;position:relative;width:24px;flex-shrink:0;">
                        ...
                        <div style="width:16px;height:16px;border-radius:50%;background:#93c5fd;border:4px solid white;box-shadow:0 0 0 4px #93c5fd;position:relative;z-index:2;margin-top:10px;"></div>
                    </div>
                    <div style="flex:1;padding-left:2.5rem;padding-bottom:3.5rem;">
                        <div style="background:white;border-radius:1.25rem;padding:2rem 2.25rem;box-shadow:0 4px 20px rgba(30,58,110,0.06);border:1px solid rgba(30,58,110,0.05);transition:transform 0.3s, box-shadow 0.3s;" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 12px 30px rgba(30,58,110,0.12)';" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 4px 20px rgba(30,58,110,0.06)';">
                ...
                <div class="reveal reveal-delay-1" style="display:flex;align-items:stretch;width:100%;">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;position:relative;width:24px;flex-shrink:0;">
                        <div style="width:16px;height:16px;border-radius:50%;background:#bfdbfe;border:4px solid white;box-shadow:0 0 0 4px #2563eb;position:relative;z-index:2;margin-top:10px;"></div>
                    </div>
...
"""
content = "".join([content[:match.start(1)], new_roadmap, content[match.end():]])
